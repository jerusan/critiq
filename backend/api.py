from backend.types.ControversialResult import ControversialResult
from flask import Blueprint, jsonify, request
from .server import get_opposing_view_query, get_opposing_view_summary

api_bp = Blueprint("api", __name__)

@api_bp.route("/get-controversy-summary", methods=["GET"])
def api_get_controversy_summary():
